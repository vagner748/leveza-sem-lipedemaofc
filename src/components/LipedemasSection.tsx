...
const LipedemasSection = () => {
  ...
  return (
    <section id="lipedema" className="py-20 scroll-mt-20 bg-custom-green text-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={headerRef} className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="font-semibold text-white">CONSCIENTIZAÇÃO</span>
            </div>
            
            <h2 className="font-display text-4xl font-bold mb-6 md:text-5xl">
              <span className="text-white">11%</span> das mulheres sofrem de lipedema
            </h2>
          ...
          <div ref={statsRef} className="grid md:grid-cols-3 gap-8 mb-16">
            {facts.map((fact, index) => (
              <div 
                key={index} 
                className={`bg-white/10 p-6 rounded-lg text-center ${fact.highlight ? 'border-white border-2' : 'border-transparent border-2'}`}
              >
                <div className={`text-5xl font-bold mb-4 ${fact.highlight ? 'text-white' : 'text-white'}`}>
                  {fact.stat}
                </div>
                ...
                {fact.highlight && (
                  <div className="w-full h-1 bg-white/50 rounded-full mt-4"></div>
                )}
              </div>
            ))}
          </div>
          ...
          {/* What is Lipedema */}
          <div ref={whatIsRef} className="bg-white/10 rounded-2xl p-8 md:p-12 mb-16">
          ...
          <div ref={ctaRef} className="text-center mt-16">
            <div className="bg-white/10 text-white rounded-2xl p-8 md:p-12">
              ...
              <p className="text-lg opacity-90 mb-6 max-w-2xl mx-auto md:text-xl">
