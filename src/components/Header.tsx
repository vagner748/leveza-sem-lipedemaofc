...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/20 backdrop-blur-md border-b border-border/30 h-[55px]" style={{ backgroundImage: 'url(/logo-wanna/logo-wanna-2.webp)', backgroundSize: 'contain', backgroundPosition: '25% center', backgroundRepeat: 'no-repeat' }}>
